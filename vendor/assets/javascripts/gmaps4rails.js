// gmaps4rails 2.1.2 — JavaScript compilé, versionné à dessein.
//
// Le gem ne livre son client qu'en CoffeeScript (vendor/assets/javascripts/
// gmaps/**/*.coffee). Le compiler à chaque build imposerait coffee-rails, donc
// ExecJS, donc un runtime JavaScript — que la sandbox railsbox n'a pas (VM i386
// sans Node) et qu'aucun autre besoin de l'application ne justifie.
//
// Ce fichier est la sortie de `Rails.application.assets["gmaps/google.js"].source`
// avec coffee-rails installé : l'arbre complet (base, objects, google/builders,
// google/objects), directives Sprockets déjà résolues. Le gem est figé depuis
// 2015 ; à régénérer seulement s'il change de version.
//
// Le gem reste au Gemfile : Gmaps4rails.build_markers est appelé côté serveur
